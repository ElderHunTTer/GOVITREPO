...
This will be my casual thoughts process - Non Professional Persay....
    ...
    Gonna be using Supabase as accessing and usage of the MCP they have is easy for me to use as my current project uses it. The only issue bwith using SUPABASE and not a self hosted system is jsut the lmitations of the egress and I/O which should be enough for our test product...

    While trying to come up with alchol labels for demos... im wondering if there is already some kind of db/api i can access that will have all this information that i can just scrape or request info ont he fly about... well i should have to since i beleive internally you guys would have access to that kind of information.

    Ills tick to a curated system of labels, maybe like 20 or 30 with the option for AAdmins nd Reviewers to Import more for testing purposes and showcasing features.
